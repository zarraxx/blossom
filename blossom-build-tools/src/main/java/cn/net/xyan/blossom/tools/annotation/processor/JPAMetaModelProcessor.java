...
@SupportedOptions({
        JPAMetaModelProcessor.DEBUG_OPTION,
        JPAMetaModelProcessor.PERSISTENCE_XML_OPTION,
        JPAMetaModelProcessor.ORM_XML_OPTION,
        JPAMetaModelProcessor.FULLY_ANNOTATION_CONFIGURED_OPTION,
        JPAMetaModelProcessor.LAZY_XML_PARSING,
        JPAMetaModelProcessor.ADD_GENERATION_DATE,
        JPAMetaModelProcessor.ADD_GENERATED_ANNOTATION,
        JPAMetaModelProcessor.ADD_SUPPRESS_WARNINGS_ANNOTATION
})
public class JPAMetaModelProcessor extends AbstractProcessor {
    ...
    public void init(ProcessingEnvironment env) {
        ...
        String tmp = env.getOptions().get( JPAMetaModelProcessor.ADD_GENERATED_ANNOTATION );
        if ( tmp != null ) {
            boolean addGeneratedAnnotation = Boolean.parseBoolean( tmp );
            context.setAddGeneratedAnnotation( addGeneratedAnnotation );
        }

        tmp = env.getOptions().get( JPAMetaModelProcessor.ADD_GENERATION_DATE );
        boolean addGenerationDate = Boolean.parseBoolean( tmp );
        context.setAddGenerationDate( addGenerationDate );

        tmp = env.getOptions().get( JPAMetaModelProcessor.ADD_SUPPRESS_WARNINGS_ANNOTATION );
        ...
        tmp = env.getOptions().get( JPAMetaModelProcessor.FULLY_ANNOTATION_CONFIGURED_OPTION );
    ...
    private void createMetaModelClasses() {
        ...
        for ( MetaEntity entity : context.getMetaEntities() ) {
            ...
            JPAMetaModelClassWriter.writeFile( entity, context );
